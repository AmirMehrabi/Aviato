...
return new class extends Migration
{
    public function up(): void
    {
        if (! Schema::hasColumn('users', 'role')) {
            Schema::table('users', fn (Blueprint $table) => $table->string('role', 30)->default('admin')->index());
        }
        ...
        if (! Schema::hasColumn('users', 'last_login_ip')) {
            Schema::table('users', fn (Blueprint $table) => $table->string('last_login_ip', 45)->nullable());
        }
