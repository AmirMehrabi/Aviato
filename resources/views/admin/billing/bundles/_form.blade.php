...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <label class="flex items-center gap-3 rounded-lg border border-slate-200 p-4"><input type="checkbox" name="show_on_marketing" value="1" @checked(old('show_on_marketing', $bundle->show_on_marketing ?? true)) class="size-4 rounded border-slate-300 text-[#0069FF]"><span class="text-sm font-black text-slate-700">نمایش در home / pricing / solutions</span></label>
</div>
