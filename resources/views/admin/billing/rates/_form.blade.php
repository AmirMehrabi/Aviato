...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <x-form.input name="monthly_price" type="number" label="قیمت ماهانه واحد" :value="$rate->monthly_price" />
    ...
    <label class="mt-8 flex items-center gap-3 rounded-lg border border-slate-200 p-4">
        <input type="checkbox" name="is_active" value="1" @checked(old('is_active', $rate->is_active ?? true)) class="size-4 rounded border-slate-300 text-[#0069FF]">
