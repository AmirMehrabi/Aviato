    ...
    $releases = [
        [
            ...
            'items' => [
                ...
                'ساخت خودکار نام VPS با قالب یکتا بر اساس تاریخ، مشخصات پلن و کلید اختصاصی',
        ...
        [
            ...
            'items' => [
                'امکان مدیریت و تعویض آیپی',
                'امکان احراز هویت از طریق سامانه شاهکار',
                'امکان مدیریت کیف پول از طریق حساب مدیر فضای کار',
            ],
        ],
        [
            'version' => '0.9.1',
            ...
            // 'summary' => 'این نسخه روی تبدیل صفحه خانه به یک لندینگ فروش VPS و پاکسازی مسیرهای ورود و ثبت نام برای پنل‌ها تمرکز دارد.',
            'items' => [
                'افزودن Woskspaceها به پروژه',
                'امکان مدیریت فضاهای کاری و اعضای آن‌ها',
                'مدیریت نقش‌های فضاهای کاری',
            ],
        ],
        [
            'version' => '0.9.0',
            ...
            // 'summary' => 'این نسخه روی تبدیل صفحه خانه به یک لندینگ فروش VPS و پاکسازی مسیرهای ورود و ثبت نام برای پنل‌ها تمرکز دارد.',
            'items' => [
                'امکان بازسازی ماشین‌های مجازی از طریق پنل کاربری',
                'امکان مدیریت کردن IPAM از طریق پنل مدیریت',
                'بازطراحی پنل مدیریتی در راستای یکپارچکی پنل در بخش ادمین و کاربران',
            ],
        ],
        [
            'version' => '0.8.9',
            ...
            // 'summary' => 'این نسخه روی تبدیل صفحه خانه به یک لندینگ فروش VPS و پاکسازی مسیرهای ورود و ثبت نام برای پنل‌ها تمرکز دارد.',
            'items' => [
                'اضافه شدن قابلیت حذف ماشین‌های مجازی',
                'افزودن صف‌های مجزا برای عملیات‌های ارتقاً، حذف و Provision کردن ماشین‌ها',
                'افزودن دکمه‌ی فراموشی رمز عبور',
                'افزودن امکان ساخت ماشین مجازی Router OS',
            ],
        ],
        [
            'version' => '0.8.8',
            ...
            // 'summary' => 'این نسخه روی تبدیل صفحه خانه به یک لندینگ فروش VPS و پاکسازی مسیرهای ورود و ثبت نام برای پنل‌ها تمرکز دارد.',
            'items' => [
                'اضافه کردن قابلیت آپگرید پلن سرورها',
                'افزودن امکان دسترسی به Console برای سرورها',
                'بازطراحی نوار ناوبری در پنل کاربری',
                'بهبود رابط کاربری برای موبایل',
            ],
        ],
        [
            'version' => '0.8.7',
