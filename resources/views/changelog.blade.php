    ...
    $releases = [
        ...
        [
            ...
            'items' => [
                ...
                'افزایش امنیت حساب با احراز هویت هویتی از طریق سامانه شاهکار',
        ...
        [
            ...
            // 'summary' => 'این نسخه روی تبدیل صفحه خانه به یک لندینگ فروش VPS و پاکسازی مسیرهای ورود و ثبت نام برای پنل‌ها تمرکز دارد.',
            'items' => [
                'امکان بازسازی VPS از داخل پنل مشتری برای نصب دوباره سیستم عامل و دریافت دسترسی تازه',
        ...
        [
            ...
            // 'summary' => 'این نسخه روی تبدیل صفحه خانه به یک لندینگ فروش VPS و پاکسازی مسیرهای ورود و ثبت نام برای پنل‌ها تمرکز دارد.',
            'items' => [
                'امکان حذف VPSهای دیگر مورد نیاز نبودند، مستقیم از داخل پنل مشتری',
        ...
        [
            ...
            // 'summary' => 'این نسخه روی تبدیل صفحه خانه به یک لندینگ فروش VPS و پاکسازی مسیرهای ورود و ثبت نام برای پنل‌ها تمرکز دارد.',
            'items' => [
                'امکان ارتقای پلن VPS برای افزایش منابع بدون شروع دوباره از صفر',
