...
@section('header_subtitle', 'موجودی مؤثر کیف پول این فضای کاری به صفر یا کمتر رسیده است')
        ...
        <div class="space-y-6">
            <div class="rounded-2xl border border-red-200 bg-red-50 p-6 shadow-sm shadow-red-200/50 sm:p-8">
                ...
                <p class="mt-5 text-sm leading-8 text-red-800">
                    موجودی مؤثر این فضای کاری به صفر یا کمتر رسیده است.
                    آستانه اعلان فقط برای ارسال هشدار است؛ محدودیت استفاده زمانی اعمال می‌شود که موجودی به صفر یا کمتر برسد.
                </p>
        ...
        <aside class="space-y-4">
            <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm shadow-slate-200/60">
                ...
                <div class="mt-4 space-y-3 text-sm leading-7 text-slate-600">
                    ...
                    <p>فضاهای کاری، صورتحساب‌ها و تراکنش‌های مالی همچنان در دسترس هستند.</p>
