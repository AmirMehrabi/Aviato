...
<head>
    <meta charset="utf-8">
    <title>کد ورود یک‌بارمصرف</title>
</head>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:560px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
        <tr>
            <td style="padding:24px;border-bottom:1px solid #e2e8f0;background:linear-gradient(180deg,#eaf4ff 0%,#ffffff 100%);">
                <p style="margin:0 0 10px 0;font-size:12px;font-weight:700;color:#2563eb;">ورود امن به پنل مشتری</p>
                <h1 style="margin:0;font-size:24px;line-height:1.4;color:#0f172a;">کد ورود یک‌بارمصرف</h1>
            </td>
        </tr>
        <tr>
            <td style="padding:24px;">
                <p style="margin:0 0 16px 0;font-size:14px;line-height:1.9;color:#334155;">{{ $customer->name }} عزیز، برای ورود به پنل مشتری این کد را وارد کنید:</p>
                ...
                <p style="margin:0;font-size:13px;line-height:1.9;color:#64748b;">این کد تا ۱۰ دقیقه معتبر است. اگر شما درخواست ورود نداده‌اید، این ایمیل را نادیده بگیرید.</p>
            </td>
        </tr>
    </table>
</body>
