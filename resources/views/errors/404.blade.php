...
<head>
    ...
    <title>صفحه یافت نشد | آویاتو</title>
...
<body class="min-h-screen overflow-x-hidden bg-[#F5F8FD] text-slate-950 antialiased">
    ...
    <main class="flex min-h-screen items-center justify-center px-4 pt-24 pb-16">
        <div class="mx-auto max-w-2xl text-center">
            <div class="relative">
                <p class="text-[8rem] font-black leading-none text-[#EEF5FF] select-none sm:text-[12rem]">۴۰۴</p>
                <div class="absolute inset-0 flex items-center justify-center">
                    <span class="text-5xl font-black text-[#0069FF] sm:text-7xl">۴۰۴</span>
                </div>
            </div>

            <h1 class="mt-2 text-2xl font-bold text-slate-950 sm:text-3xl">صفحه مورد نظر یافت نشد</h1>
            <p class="mx-auto mt-4 max-w-md text-sm leading-8 text-slate-600">
                به نظر می‌رسد صفحه‌ای که دنبال آن هستید جابه‌جا شده، حذف شده یا اصلا وجود نداشته است.
            </p>
