...
@section('title', 'آویاتو | سرور ابری در کمتر از یک دقیقه')
@section('description', 'ماشین مجازی سریع با دیسک NVMe، IP اختصاصی، بکاپ روزانه و پشتیبانی فارسی. بدون قرارداد، پرداخت ساعتی و امکان لغو در لحظه.')
    ...
    <section id="top" class="relative overflow-hidden bg-gradient-to-b from-[#EBF3FF] via-white to-white px-4 pb-20 pt-16 md:px-8 md:pb-28 md:pt-24 lg:px-10">
        ...
        <div class="relative mx-auto max-w-4xl text-center">
            ...
            <div class="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
                ...
                <a href="{{ route('pricing') }}" class="inline-flex w-full items-center justify-center rounded-lg border border-slate-200 bg-white px-7 py-4 text-base font-black text-slate-800 transition hover:border-[#B8D6FF] hover:text-[#0069FF] sm:w-auto">
                    دیدن قیمت ها
                </a>
            </div>
        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                @foreach ([
                    ...
                    ['title' => 'امنیت پایه آماده', 'body' => 'فایروال، شبکه خصوصی و بکاپ روزانه برای هر ماشین.'],
            ...
            <div class="grid gap-4 md:grid-cols-3">
                @foreach ([
                    ...
                    <article class="rounded-lg border p-5 shadow-sm {{ $plan['tone'] }}">
                        ...
                        <a href="{{ route('pricing') }}" class="mt-6 inline-flex w-full justify-center rounded-lg bg-[#0069FF] px-4 py-3 text-sm font-black text-white transition hover:bg-[#0050D0]">جزئیات پلن</a>
                    </article>
                @endforeach
            </div>
        </div>
    ...
    <section class="px-4 pb-20 pt-8 md:px-8 lg:px-10">
        <div class="mx-auto max-w-7xl overflow-hidden rounded-2xl bg-[#0069FF] p-8 text-white shadow-2xl shadow-[#0069FF]/20 md:p-12">
            <div class="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                ...
                <a href="{{ route('solutions') }}" class="inline-flex items-center justify-center rounded-lg bg-white px-7 py-4 text-base font-black text-[#0069FF] shadow-xl transition hover:bg-blue-50">دیدن راهکارها</a>
            </div>
        </div>
    </section>
@endsection
